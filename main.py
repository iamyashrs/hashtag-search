...
def get_data(query):
    ...
    for i in fb['data']:
        ...
        # f.write(i['link'])
        # f.write('\n')
        # f.write('https://facebook.com/'+i['id'].replace('_','/posts/'))
        q['id']='https://facebook.com/'+i['id'].replace('_','/posts/')
        # f.write('\n')
        if i['type']=='status':
            # f.write('status\t'+i['from']['name'].encode('utf8')+'\t'+'https://facebook.com/'+i['from']['id'].encode('utf8')+'\n')
            try:
                q['story']=i['story']
            ...
            # f.write('link\t'+i['from']['name'].encode('utf8')+'\t'+'https://facebook.com/'+i['from']['id'].encode('utf8')+'\n')
            try:
                # f.write(i['story'].encode('utf8') + '\n')
                q['story']=i['story']
            except:
            ...
            # f.write('photo\t'+i['from']['name'].encode('utf8')+'\t'+'https://facebook.com/'+i['from']['id'].encode('utf8')+'\n')
            # f.write(i['picture']+'\n')
            try:
                # f.write(i['story'].encode('utf8') + '\n')
                q['story']=i['story']
            ...
            # f.write('video\t'+i['from']['name'].encode('utf8')+'\t'+'https://facebook.com/'+i['from']['id'].encode('utf8')+'\n')
            # f.write(i['picture']+'\n')
            try:
                # f.write(i['story'].encode('utf8') + '\n')
                q['story']=i['story']
        ...
        fbdict.append(q)
    # f.write('\n')
    # f.write('previous page: '+fb['paging']['previous'])
    # f.write('\n')
    # f.write('next page: '+fb['paging']['next'])
    # f.write('\n')
